...
seoul = pd.read_csv('sq-yeon/bigproject/seoul_predict_2.csv')
    ...
    if loca_1 == '서울':
        ...
        if loca_2 == '전체':
            ...
            if (df_jr.shape[0]==0):
                ...
                s_map = g.Map(location=[37.57037778, 126.9816417], zoom_start=13)
                for i in range(len(df_jr)):
                    marker01 = g.Marker([df_jr.iloc[i]['lat'], df_jr.iloc[i]['lon']], tooltip=df_jr.iloc[i]['시설명']).add_to(s_map)
                folium_static(s_map)
                st.dataframe(seoul_jr)
        elif loca_2 == '송파':
            seoul_all = seoul.sort_values(by=['빗물 이용시설 설치 적합여부[0/1]', '빗물목표량대비사용량'], ascending=[False, False])
            ...
            if (df_sp.shape[0]==0):
                ...
                _map = g.Map(location=[37.51175556, 127.1079306], zoom_start=13)
                for i in range(len(df_sp)):
                    marker01 = g.Marker([df_sp.iloc[i]['lat'], df_sp.iloc[i]['lon']], tooltip=df_sp.iloc[i]['시설명']).add_to(s_map)
                folium_static(s_map)
                st.dataframe(seoul_sp)
        elif loca_2 == '성동':
            seoul_all = seoul.sort_values(by=['빗물 이용시설 설치 적합여부[0/1]', '빗물목표량대비사용량'], ascending=[False, False])
            ...
            if (df_sd.shape[0]==0):
                map = g.Map(location=[37.56061111, 127.039], zoom_start=13)
                for i in range(len(df_sd)):
                    marker01 = g.Marker([df_sd.iloc[i]['lat'], df_sd.iloc[i]['lon']], tooltip=df_sd.iloc[i]['시설명']).add_to(s_map)
                folium_static(s_map)
            ...
            if (df_kj.shape[0]==0):
                ...
                map = g.Map(location=[37.53573889, 127.0845333], zoom_start=13)
                for i in range(len(df_kj)):
                    marker01 = g.Marker([df_kj.iloc[i]['lat'], df_kj.iloc[i]['lon']], tooltip=df_kj.iloc[i]['시설명']).add_to(s_map)
                folium_static(s_map)
                st.dataframe(seoul_kj)
        elif loca_2 == '중구':
            seoul_all = seoul.sort_values(by=['빗물 이용시설 설치 적합여부[0/1]', '빗물목표량대비사용량'], ascending=[False, False])
            ...
            if (df_jk.shape[0]==0):
                ...
                map = g.Map(location=[37.56100278, 126.9996417], zoom_start=13)
                for i in range(len(df_jk)):
                    marker01 = g.Marker([df_jk.iloc[i]['lat'], df_jk.iloc[i]['lon']], tooltip=df_jk.iloc[i]['시설명']).add_to(s_map)
                folium_static(s_map)
                st.dataframe(seoul_jk)
        elif loca_2 == '중랑':
            seoul_all = seoul.sort_values(by=['빗물 이용시설 설치 적합여부[0/1]', '빗물목표량대비사용량'], ascending=[False, False])
            ...
            if (df_jrk.shape[0]==0):
                ...
                map = g.Map(location=[37.60380556, 127.0947778], zoom_start=13)
                for i in range(len(df_jrk)):
                    marker01 = g.Marker([df_jrk.iloc[i]['lat'], df_jrk.iloc[i]['lon']], tooltip=df_jrk.iloc[i]['시설명']).add_to(s_map)
                folium_static(s_map)
                st.dataframe(seoul_jrk)
        elif loca_2 == '성북':
            seoul_all = seoul.sort_values(by=['빗물 이용시설 설치 적합여부[0/1]', '빗물목표량대비사용량'], ascending=[False, False])
            ...
            if (df_sb.shape[0]==0):
                ...
                map = g.Map(location=[37.58638333, 127.0203333], zoom_start=13)
                for i in range(len(df_sb)):
                    marker01 = g.Marker([df_sb.iloc[i]['lat'], df_sb.iloc[i]['lon']], tooltip=df_sb.iloc[i]['시설명']).add_to(s_map)
                folium_static(s_map)
                st.dataframe(seoul_sb)
        elif loca_2 == '영등포':
            seoul_all = seoul.sort_values(by=['빗물 이용시설 설치 적합여부[0/1]', '빗물목표량대비사용량'], ascending=[False, False])
            ...
            if (df_ydp.shape[0]==0):
                ...
                map = g.Map(location=[37.52361111, 126.8983417], zoom_start=13)
                for i in range(len(df_ydp)):
                    marker01 = g.Marker([df_ydp.iloc[i]['lat'], df_ydp.iloc[i]['lon']], tooltip=df_ydp.iloc[i]['시설명']).add_to(s_map)
                folium_static(s_map)
                st.dataframe(seoul_ydp)
        elif loca_2 == '서초':
            seoul_all = seoul.sort_values(by=['빗물 이용시설 설치 적합여부[0/1]', '빗물목표량대비사용량'], ascending=[False, False])
            ...
            if (df_sc.shape[0]==0):
                ...
                map = g.Map(location=[37.48078611, 127.0348111], zoom_start=13)
                for i in range(len(df_sc)):
                    marker01 = g.Marker([df_sc.iloc[i]['lat'], df_sc.iloc[i]['lon']], tooltip=df_sc.iloc[i]['시설명']).add_to(s_map)
                folium_static(s_map)
                st.dataframe(seoul_sc)
        elif loca_2 == '양천':
            seoul_all = seoul.sort_values(by=['빗물 이용시설 설치 적합여부[0/1]', '빗물목표량대비사용량'], ascending=[False, False])
            ...
            if (df_yc.shape[0]==0):
                ...
                map = g.Map(location=[37.51423056, 126.8687083], zoom_start=13)
                for i in range(len(df_yc)):
                    marker01 = g.Marker([df_yc.iloc[i]['lat'], df_yc.iloc[i]['lon']], tooltip=df_yc.iloc[i]['시설명']).add_to(s_map)
                folium_static(s_map)
                st.dataframe(seoul_yc)
        elif loca_2 == '강남':
            seoul_all = seoul.sort_values(by=['빗물 이용시설 설치 적합여부[0/1]', '빗물목표량대비사용량'], ascending=[False, False])
            ...
            if (df_kn.shape[0]==0):
                ...
                map = g.Map(location=[37.514575, 127.0495556], zoom_start=13)
                for i in range(len(df_kn)):
                    marker01 = g.Marker([df_kn.iloc[i]['lat'], df_kn.iloc[i]['lon']], tooltip=df_kn.iloc[i]['시설명']).add_to(s_map)
                folium_static(s_map)
                st.dataframe(seoul_kn)
        elif loca_2 == '강동':
            seoul_all = seoul.sort_values(by=['빗물 이용시설 설치 적합여부[0/1]', '빗물목표량대비사용량'], ascending=[False, False])
            ...
            if (df_kd.shape[0]==0):
                ...
                map = g.Map(location=[37.52736667, 127.1258639], zoom_start=13)
                for i in range(len(df_kd)):
                    marker01 = g.Marker([df_kd.iloc[i]['lat'], df_kd.iloc[i]['lon']], tooltip=df_kd.iloc[i]['시설명']).add_to(s_map)
                folium_static(s_map)
                st.dataframe(seoul_kd)
        elif loca_2 == '강북':
            seoul_all = seoul.sort_values(by=['빗물 이용시설 설치 적합여부[0/1]', '빗물목표량대비사용량'], ascending=[False, False])
            ...
            if (df_kb.shape[0]==0):
                ...
                map = g.Map(location=[37.63695556, 127.0277194], zoom_start=13)
                for i in range(len(df_kb)):
                    marker01 = g.Marker([df_kb.iloc[i]['lat'], df_kb.iloc[i]['lon']], tooltip=df_kb.iloc[i]['시설명']).add_to(s_map)
                folium_static(s_map)
                st.dataframe(seoul_kb)
        elif loca_2 == '강서':
            seoul_all = seoul.sort_values(by=['빗물 이용시설 설치 적합여부[0/1]', '빗물목표량대비사용량'], ascending=[False, False])
            ...
            if (df_ks.shape[0]==0):
                ...
                map = g.Map(location=[37.54815556, 126.851675], zoom_start=13)
                for i in range(len(df_ks)):
                    marker01 = g.Marker([df_ks.iloc[i]['lat'], df_ks.iloc[i]['lon']], tooltip=df_ks.iloc[i]['시설명']).add_to(s_map)
                folium_static(s_map)
                st.dataframe(seoul_ks)
        elif loca_2 == '관악':
            seoul_all = seoul.sort_values(by=['빗물 이용시설 설치 적합여부[0/1]', '빗물목표량대비사용량'], ascending=[False, False])
            ...
            if (df_ka.shape[0]==0):
                ...
                map = g.Map(location=[37.47538611, 126.9538444], zoom_start=13)
                for i in range(len(df_ka)):
                    marker01 = g.Marker([df_ka.iloc[i]['lat'], df_ka.iloc[i]['lon']], tooltip=df_ka.iloc[i]['시설명']).add_to(s_map)
                folium_static(s_map)
                st.dataframe(seoul_ka)
        elif loca_2 == '구로':
            seoul_all = seoul.sort_values(by=['빗물 이용시설 설치 적합여부[0/1]', '빗물목표량대비사용량'], ascending=[False, False])
            ...
            if (df_kr.shape[0]==0):
                ...
                map = g.Map(location=[37.49265, 126.8895972], zoom_start=13)
                for i in range(len(df_kr)):
                    marker01 = g.Marker([df_kr.iloc[i]['lat'], df_kr.iloc[i]['lon']], tooltip=df_kr.iloc[i]['시설명']).add_to(s_map)
                folium_static(s_map)
                st.dataframe(seoul_kr)
        elif loca_2 == '금천':
            seoul_all = seoul.sort_values(by=['빗물 이용시설 설치 적합여부[0/1]', '빗물목표량대비사용량'], ascending=[False, False])
            ...
            if (df_kc.shape[0]==0):
                ...
                map = g.Map(location=[37.44910833, 126.9041972], zoom_start=13)
                for i in range(len(df_kc)):
                    marker01 = g.Marker([df_kc.iloc[i]['lat'], df_kc.iloc[i]['lon']], tooltip=df_kc.iloc[i]['시설명']).add_to(s_map)
                folium_static(s_map)
                st.dataframe(seoul_kc)
        elif loca_2 == '노원':
            seoul_all = seoul.sort_values(by=['빗물 이용시설 설치 적합여부[0/1]', '빗물목표량대비사용량'], ascending=[False, False])
            ...
            if (df_nw.shape[0]==0):
                ...
                map = g.Map(location=[37.65146111, 127.0583889], zoom_start=13)
                for i in range(len(df_nw)):
                    marker01 = g.Marker([df_nw.iloc[i]['lat'], df_nw.iloc[i]['lon']], tooltip=df_nw.iloc[i]['시설명']).add_to(s_map)
                folium_static(s_map)
                st.dataframe(seoul_nw)
        elif loca_2 == '도봉':
            seoul_all = seoul.sort_values(by=['빗물 이용시설 설치 적합여부[0/1]', '빗물목표량대비사용량'], ascending=[False, False])
            ...
            if (df_db.shape[0]==0):
                ...
                map = g.Map(location=[37.66583333, 127.0495222], zoom_start=13)
            ...
            if (df_ddm.shape[0]==0):
                ...
                map = g.Map(location=[37.571625, 127.0421417], zoom_start=13)
            ...
            if (df_dj.shape[0]==0):
                ...
                map = g.Map(location=[37.50965556, 126.941575], zoom_start=13)
            ...
            if (df_mp.shape[0]==0):
                ...
                map = g.Map(location=[37.56070556, 126.9105306], zoom_start=13)
            ...
            if (df_sdm.shape[0]==0):
                ...
                map = g.Map(location=[37.57636667, 126.9388972], zoom_start=13)
            ...
            if (df_ys.shape[0]==0):
                ...
                map = g.Map(location=[37.53609444, 126.9675222], zoom_start=13)
            ...
            if (df_ep.shape[0]==0):
                ...
                map = g.Map(location=[37.59996944, 126.9312417], zoom_start=13)
